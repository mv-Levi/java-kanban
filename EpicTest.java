...
class EpicTest {
    ...
    public void testEpicStatusAllNew() {
        ...
        Subtask subtask2 = new Subtask(3, "Subtask 2", "Description 2",
                TaskStatus.IN_PROGRESS, epic.getTaskId(), LocalDateTime.of(2022, 1, 1, 11, 0),
                Duration.ofHours(3));
    ...
    public void testEpicStatusAllDone() {
        Epic epic = new Epic(1, "Epic", "Description", TaskStatus.NEW, startTime, duration, taskManager);
        taskManager.createEpic(epic);
        Subtask subtask1 = new Subtask(2, "Subtask 1", "Description 1", TaskStatus.DONE, epic.getTaskId(), startTime, duration);
        Subtask subtask2 = new Subtask(3, "Subtask 2", "Description 2", TaskStatus.DONE, epic.getTaskId(), startTime.plusHours(1), duration);
    ...
    public void testEpicStatusMixed() {
        Epic epic = new Epic(1, "Epic", "Description", TaskStatus.NEW, startTime, duration, taskManager);
        taskManager.createEpic(epic);
        Subtask subtask1 = new Subtask(2, "Subtask 1", "Description 1", TaskStatus.NEW, epic.getTaskId(), startTime, duration);
        Subtask subtask2 = new Subtask(3, "Subtask 2", "Description 2", TaskStatus.DONE, epic.getTaskId(), startTime.plusHours(1), duration);
        taskManager.createSubtask(subtask1);
        taskManager.createSubtask(subtask2);
    ...
    public void testEpicStatusInProgress() {
        Epic epic = new Epic(1, "Epic", "Description", TaskStatus.NEW, startTime, duration, taskManager);
        taskManager.createEpic(epic);
        Subtask subtask1 = new Subtask(2, "Subtask 1", "Description 1", TaskStatus.IN_PROGRESS, epic.getTaskId(), startTime, duration);
        taskManager.createSubtask(subtask1);
    ...
    public void testEpicTimingUpdates() {
        Epic epic = new Epic(1, "Complex Epic", "Testing timings", TaskStatus.NEW,
